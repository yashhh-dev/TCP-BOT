...
"""
                        ...
                        if inPuTMsG.strip() == '/stop evo_c':
                            if evo_custom_spam_task and not evo_custom_spam_task.done():
                                evo_custom_spam_running = False
                                evo_custom_spam_task.cancel()
                                success_msg = f"[b][FFFFFF]✅ SUCCESS! Evolution custom spam stopped successfully! YT @NAJMI FF EXPERIMENT .07\n"
                                await safe_send_message(response.Data.chat_type, success_msg, uid, chat_id, key, iv)
                            else:
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = """[b][00FF00]✨ NAJMI t PRIVATE BOT ✨
...
-> [00FF00]Join Req Pro Badge"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # Footer
                            footer = """[C][b][1E90FF]╭━━━━━━━━━╮
[1E90FF]┃ [00FF00]CREDITS: @NAJMI_FF_EXPERIMENT [1E90FF]
[1E90FF]┃ [00FF00]YOUTUBE @NAJMI FF EXPERIMENT .07[1E90FF]
[1E90FF]┃ [00FF00]DEVELOPER: NAJMI FF EXPERIMENT [1E90FF]
[1E90FF]┃ [00FF00]BOT STATUS: ONLINE[1E90FF]
[1E90FF]┃ [00FF00]NAJMI[1E90FF]
[1E90FF]╰━━━━━━━━━╯"""
...
async def MaiiiinE():
    Uid , Pw = '4375226615','2A1E6FA49780FD87DA99E9976337E50D3CD728E8E36C6D0CAF379F091D4A67F9'
